...
def predict_landslide_category(landslide_trigger, landslide_region):
    ...
    predicted_category = label_encoders['landslide_category'].inverse_transform(
        prediction
    )
...
landslide_trigger_input = st.selectbox(
    "Select Landslide Trigger:", label_encoders['landslide_trigger'].classes_
)

landslide_region_input = st.selectbox(
    "Select Landslide Region:", label_encoders['landslide_region'].classes_
)

# Button to make prediction
if st.button("Predict Landslide Category"):
    predicted_category = predict_landslide_category(
        landslide_trigger_input, landslide_region_input
    )
